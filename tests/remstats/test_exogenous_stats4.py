"""Type-expanded undirected actor-covariate regression tests."""
...
def test_type_expanded_undirected_actor_covariates_match_expected_matrices():
    result = _statistics()
    expected = {
...
def test_type_expanded_undirected_standardization_matches_definition():
    raw = _statistics()
    with pytest.warns(DeprecationWarning, match="attr_actors"):
